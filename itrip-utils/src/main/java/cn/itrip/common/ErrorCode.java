...
public class ErrorCode {
    ...
    public final static String AUTH_REPLACEMENT_TIME_PROTECTE="30009";//置换token失败,时间保护
    public final static String AUTH_TOKEN_INVALID="30006";//token无效
    public static final String AUTH_ILLEGAL_USERCODE = "30007";//非法的用户名
    public static final String AUTH_NOT_ACTIVATED = "30008";//未激活
